      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            className="fixed bottom-4 md:bottom-6 right-4 md:right-6 z-[100] w-14 h-14 md:w-16 md:h-16 bg-white text-black rounded-full shadow-2xl flex items-center justify-center cursor-pointer group border border-white/20"
          >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-4 md:bottom-6 right-4 md:right-6 z-[100] w-[calc(100vw-2rem)] md:w-[400px] h-[500px] md:h-[550px] max-h-[80vh] bg-neutral-950 rounded-2xl border border-white/20 shadow-2xl flex flex-col overflow-hidden"
          >
            {/* Header */}
