export const courseCategories = [
  ...
  },
  {
    ...
    courses: [
      "Fashion Design", "Interior Design", "Graphic Design", "Product Design", 
      "Animation", "VFX", "Multimedia", "Photography", "Film Making", 
      "Fine Arts", "Game Art", "UI/UX Design"
    ]
  },
  {
    ...
    courses: [
      "Bachelor of Hotel Management", "Travel and Tourism", "Culinary Arts", 
      "Bakery and Confectionery", "Cruise Management", "Resort Management"
    ]
  },
  {
    ...
    courses: [
      "Agriculture", "Horticulture", "Forestry", "Fisheries Science", 
      "Dairy Technology", "Veterinary Science", "Sericulture"
    ]
  },
  {
    ...
    courses: [
      "NDA", "Indian Army Technical Entry", "Indian Navy", "Indian Air Force", 
      "Coast Guard", "Merchant Navy"
    ]
  },
  {
    ...
    courses: [
      "Polytechnic", "Automobile Diploma", "Mechanical Diploma", "Civil Diploma", 
      "Electrical Diploma", "Electronics Diploma", "Computer Engineering Diploma", 
      "Fashion Design Diploma", "Hotel Management Diploma", "Animation Diploma"
    ]
  },
  {
    ...
    courses: [
      "German", "French", "Japanese", "Spanish", "Korean", "Arabic", "Chinese"
    ]
  },
  {
  ...
  },
  {
    ...
    courses: [
      "SSC", "Banking", "Railways", "Defence Exams", "State PSC", "UPSC (after graduation)"
    ]
  }
];
